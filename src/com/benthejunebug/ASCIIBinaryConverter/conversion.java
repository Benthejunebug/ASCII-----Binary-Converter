...
public class conversion {
	...
	// take a char array of text and sets returnString to the binary code
	...
	// Decides whether the user wishes to convert to binary or ASCII and calls
	// the appropriate method with the processed array
	public void stringProcess(String enteredText, int action) {
		...
		if (enteredText.isEmpty() == false) {
					...
					if (stringCh.equals("1") == false
						...
						if (action == 2) {
							...
							JOptionPane
									.showMessageDialog(
											null,
											"Only \" \",\"0\",&\"1\" allowed in binary code!",
											"ERROR",
			...
			JOptionPane.showMessageDialog(null,
					"You have not entered any text!", "ERROR",
					JOptionPane.WARNING_MESSAGE);
	...
	// Takes a string array of separate characters "1's and 0's" and sets
	// returnString to the text it converts to
